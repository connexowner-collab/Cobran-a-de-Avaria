...
const ATENDIMENTOS_BASE: AtendimentoServico[] = [
  ...
  { numero: '2066894', status: 'aberta', motivo: 'PNEU', tipo: 'corretiva', ordens: [{ numero: 'OS-343970', motivo: 'PNEU', status: 'Em execução', dataEntrada: '11/07/2026', dataSaida: '—', temAvaria: true }], placa: 'TXI3F16', chassi: '9BM958074HB779340', numeroSerie: '—', marcaModelo: 'Mercedes Accelo 815', agendamento: '10/07/2026', dataEntrada: '11/07/2026', previsao: '17/07/2026', saida: '—', dataConclusao: '—', situacao: 'Em manutenção' },
  ...
  for (let i = 0; i < n; i++) {
    ...
    switch (etapa) {
      ...
      case 'manutencao':
        ...
        situacao = 'Em manutenção'; osStatus = 'Em execução';
        break;
      case 'saida':
